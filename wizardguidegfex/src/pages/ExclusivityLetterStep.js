...
import {
  ...
  Button, TableCell, tableCellClasses
} from '@mui/material';
...
export default function ExclusivityLetterForm() {
  ...
  const addFile = async (files) => {
    ...
    const oEntry = {
      ...
      revision: "00",
      fileSize: oFile.size,
      updatedAt: getDateNowFrontFormated(),
      documentType: "Invoice",
      newDocument: true,
      expiredDate: "",
      expiredDateTime:"",
      file: sFileBase64.replace('data:application/pdf;base64,', ''),
      url: "",
      status: "",
      lastModifiedBy: ""
    }
  ...
  return (
    <React.Fragment>
      <Box className={classes.form}>
        ...
        <PrimeReactProvider>
          <div className="card">
            <DataTable emptyMessage="Adicionar Carta de Exclusividade" value={supplier.exclusivityLetter}
              tableStyle={{ minWidth: '50rem', paddingTop: '5rem' }} >
